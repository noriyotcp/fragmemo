...
// __dirname is out/main, so go up to project root's out/native
const bindingPath = path.join(__dirname, '../native', path.basename(import.meta.env.VITE_BETTER_SQLITE3_BINDING))
